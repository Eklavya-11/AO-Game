import { EngineSceneData } from "../../store/slices/sceneSlice";
      ...
      hotspots: [
        {
          ...
          rect: { x: 31, y: 41, w: 8, h: 8 }, // Positioned directly at the front door of the left forge house
        ...
        },
        {
          ...
          rect: { x: 73, y: 32, w: 8, h: 8 }, // Positioned directly at the front gate of the British outpost
        ...
        },
        {
          ...
          rect: { x: 49, y: 38, w: 8, h: 8 }, // Positioned directly at the front door of the middle village house
      ...
      interior_door_1: {
        ...
        hotspots: [
          ...
          },
          {
            ...
            rect: { x: 12, y: 65, w: 12, h: 15 }, // Positioned at the sunlit arch exit
          },
        ],
      ...
      interior_door_2: {
        ...
        hotspots: [
          ...
          },
          {
            ...
            name: "Exit Door",
            hint: "Press E to return to village square",
            rect: { x: 75, y: 78, w: 12, h: 12 }, // Positioned at stone arch exit
          },
        ],
