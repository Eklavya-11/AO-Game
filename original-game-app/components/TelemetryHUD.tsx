...
export const TelemetryHUD: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-20 right-8 z-40 bg-slate-950/90 backdrop-blur-md border border-sky-500/30 rounded-xl shadow-2xl text-slate-100 font-mono text-xs transition-all duration-300 ${
